...
def test_extract_project_title_from_common_entalma_phrases() -> None:
    assert (
        extract_project_title(
            "ΚΩΔΙΚΟΣ ΕΡΓΟΥ: 2022ΝΠ26600059 ΣΥΜΠΛΗΡΩΜΑΤΙΚΕΣ ΠΑΡΕΜΒΑΣΕΙΣ ΚΑΙ ΕΡΓΑΣΙΕΣ ΟΛΟΚΛΗΡΩΣΗΣ ΤΩΝ ΕΡΓΩΝ ΑΡΔΕΥΣΗΣ ΠΕΔΙΑΔΑΣ ΜΟΡΝΟΥ ΤΙΤΛΟΣ ΕΡΓΟΥ: GR3801000230000002082132660 IBAN ΧΡΕΩΣΗΣ ΤτΕ: ΤΙΤΛΟΣ ΥΠΟΕΡΓΟΥ"
        )
    ...
    assert extract_project_title("ΤΙΤΛΟΣ ΕΡΓΟΥ: GR3801000230000002082132660 IBAN ΧΡΕΩΣΗΣ ΤτΕ: ΤΙΤΛΟΣ") is None
    assert (
        extract_project_title(
